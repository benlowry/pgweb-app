...
$(document).ready(function() {
  ...
  $("#objects").on("click", "li", function(e) {
    ...
    sessionStorage.setItem('cacheObject22223', JSON.stringify(currentObject))
  ...
  var baseURIParts = window.frameElement.baseURI.split('?')
  var url = baseURIParts[0]
  window.bookmarkid = baseURIParts[1].split('bookmarkid=')[1]
  ...
  return apiCall('get', '/connection', {}, function (resp) {
    if (resp.error) {
      ...
      switch (window.page) {
        ...
        case 'indexes':
          return showTableIndexes()
        case 'constraints':
          return showTableConstraints()
        case 'history':
          return showQueryHistory()
        case 'query':
          return showQueryPanel()
        case 'connection':
          return showConnectionPanel()
        case 'activity':
